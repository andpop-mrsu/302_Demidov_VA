...
namespace Demidovvava\Tests;
use \PHPUnit\Framework\TestCase;
use Demidovvava\Task06_2\EconomyRoom;
use Demidovvava\Task06_2\StandardRoom;
use Demidovvava\Task06_2\SuiteRoom;
use Demidovvava\Task06_2\InternetDecorator;
use Demidovvava\Task06_2\BreakfastDecorator;
use Demidovvava\Task06_2\FoodDeliveryDecorator;
use Demidovvava\Task06_2\SofaDecorator;
